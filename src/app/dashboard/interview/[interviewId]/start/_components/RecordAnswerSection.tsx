...
import useSpeechToText, { ResultType } from 'react-hook-speech-to-text'; // Import ResultType if provided by the library
...
interface RecordAnswerSectionProps {
    mockInterviewQuestion: any[]; // Adjust the type as per your schema
